...
def make_embeddings(path, num_classes):
    """
    Make embeddings for all images from folder given with path.
    :param path: path to folder of images we want to make embedings of
    :param num_classes: number of classes we want to classify in
    """
    ...
    # transforming image to tensor of the correct size for the network input and normalizing it with ImageNet constants
    ...
    embeddings = {i: [] for i in range(num_classes)}
